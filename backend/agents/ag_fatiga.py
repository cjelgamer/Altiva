...
def run_ag_fatiga(user_id: str, estado_fisio: dict, actividad_mental: str = None, estado_emocional: str = None) -> dict:
    """
...
"""
    ...
    # 3. Llamar al LLM
    try:
        respuesta_llm = analyze_with_llm(prompt, temperature=0.3)  # Baja temperatura para consistencia
